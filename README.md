...
무빙 서비스를 빠르게 체험해 보실 수 있는 방법입니다.

### 고객

- email: tester1@test.com / pw: 12345678
- 견적 요청에서 일반 견적 요청 진행 후 서비스 유형 및 지역이 일치하는 기사에게 지정 견적 요청
- 지정 견적 요청은 '테스터2'에게 요청
- 지정 견적 요청하지 않아도 기사의 받은 요청에 노출됨
- 기사가 채팅방 개설 후 첫 견적을 보내면 채팅 시작 가능
- 채팅에서 견적 수락 시 견적 확정, 확정 1분 후 완료로 견적 상태 변화
- 견적 상태는 견적 관리에서 확인 가능
- 견적 완료 후 작성 가능한 리뷰 조회 및 등록

### 기사

- email: tester2@test.com / pw: 12345678
- 받은 요청의 서비스 가능한 고객 견적 목록에서 '테스터1' 채팅방 개설
- 견적 버튼 눌러 첫 견적 전송 후 채팅 가능
- 고객이 견적 수락 시 견적 관리에서 해당 견적 확인
- 고객이 견적 수락 후 마이페이지에서 확정 건 수 +1
- 고객이 리뷰 등록 후 마이페이지에서 리뷰와 평점 확인 가능
