  ...
  return (
    <div className="mt-[40px] flex flex-col items-center">
      ...
      <div className="mt-[24px] flex gap-5">
        <img className="cursor-pointer" src={Google.src} alt="소셜로그인" />
        <img className="cursor-pointer" src={Kakao.src} alt="소셜로그인" />
        <img className="cursor-pointer" src={Naver.src} alt="소셜로그인" />
      </div>
    </div>
  );
}
